  ...
  return (
    <QueryClientProvider client={queryClient}>
      <LocaleBoundary>
        <BrowserRouter>
          {/*
            Above the routes, and inside the router.

            A reboot started on a machine's page and finished after the
            customer moved to their invoices has to be able to say so, and a
            watcher that lived inside a route would have unmounted on the way.
            Inside the router because a message about an operation offers a way
            to the resource it is about, and a link needs somewhere to link.
          */}
          <ToastProvider>
