...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'available_until' => 'availability end',
        'bandwidth_quota_mib' => 'bandwidth quota',
        'cpu_limit_percent' => 'CPU limit',
        'description' => 'description',
        'description.ar' => 'Arabic description',
        'description.en' => 'English description',
        'disk_quota_mib' => 'disk quota',
        'entry_process_limit' => 'entry process limit',
        'io_limit_kbps' => 'I/O limit',
        'is_active' => 'offered',
        'is_public' => 'publicly listed',
        'max_addon_domains' => 'add-on domain limit',
        'max_databases' => 'database limit',
        'max_email_accounts' => 'mailbox limit',
        'max_subdomains' => 'subdomain limit',
        'memory_limit_mib' => 'memory limit',
        'name.ar' => 'Arabic name',
        'name.en' => 'English name',
        'panel_package_name' => 'panel package name',
        'per_customer_limit' => 'per-customer limit',
        'placement_constraints' => 'placement constraints',
        'process_limit' => 'process limit',
        'product_id' => 'product',
        'recurring_amount_minor' => 'recurring amount',
        'resources' => 'resources',
        'setup_amount_minor' => 'setup amount',
        'slug' => 'slug',
