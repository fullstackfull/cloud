...
return [
     ...
     */
    'attributes' => [
        'available_from' => 'بداية الإتاحة',
        'available_until' => 'نهاية الإتاحة',
        'bandwidth_quota_mib' => 'حصة النقل',
        'cpu_limit_percent' => 'حد المعالج',
        'description' => 'الوصف',
        'description.ar' => 'الوصف بالعربية',
        'description.en' => 'الوصف بالإنجليزية',
        'disk_quota_mib' => 'حصة القرص',
        'entry_process_limit' => 'حد العمليات الداخلة',
        'io_limit_kbps' => 'حد الإدخال والإخراج',
        'is_active' => 'معروض',
        'is_public' => 'مُدرج للعموم',
        'max_addon_domains' => 'حد النطاقات الإضافية',
        'max_databases' => 'حد قواعد البيانات',
        'max_email_accounts' => 'حد صناديق البريد',
        'max_subdomains' => 'حد النطاقات الفرعية',
        'memory_limit_mib' => 'حد الذاكرة',
        'name.ar' => 'الاسم بالعربية',
        'name.en' => 'الاسم بالإنجليزية',
        'panel_package_name' => 'اسم الباقة في اللوحة',
        'per_customer_limit' => 'الحد لكل عميل',
        'placement_constraints' => 'قيود التوزيع',
        'process_limit' => 'حد العمليات',
        'product_id' => 'المنتج',
        'recurring_amount_minor' => 'المبلغ الدوري',
        'resources' => 'الموارد',
        'setup_amount_minor' => 'رسوم التأسيس',
        'slug' => 'المعرّف',
