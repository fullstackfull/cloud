...
return [
    ...
    'service' => [
        ...
        'backup_needs_review' => [
            'title' => 'النسخة الاحتياطية تحتاج إلى مراجعة',
            'body' => 'لم نتمكن من تأكيد الحالة النهائية لهذه النسخة الاحتياطية. لا تعتمد عليها قبل مراجعتها.',
        ],
        'restore_needs_review' => [
            'title' => 'تحتاج عملية الاستعادة إلى مراجعة',
            'body' => 'لم نتمكن من تأكيد ما إذا كانت عملية الاستعادة قد اكتملت. يرجى التواصل مع الدعم قبل محاولة استعادة أخرى.',
        ],
        'backup_verification_failed' => [
            'title' => 'فشل فحص سلامة النسخة الاحتياطية',
            'body' => 'لم تجتز هذه النسخة فحص سلامة البيانات. لا تعتمد عليها للاستعادة قبل مراجعتها.',
        ],
        'file_restore_completed' => [
            'title' => 'استُعيدت الملفات إلى :service',
            'body' => 'أُعيد :count مسار(ات) من النسخة الاحتياطية إلى :service. وقد استُبدل ما كان في تلك المسارات من قبل.',
        ],
        'file_restore_failed' => [
            'title' => 'تعذّرت استعادة الملفات إلى :service',
            'body' => 'لم تكتمل استعادة :count مسار(ات) إلى :service. النسخة الاحتياطية نفسها غير متأثرة، والخادم كما كان.',
        ],
        'file_restore_needs_review' => [
            'title' => 'نراجع استعادة ملفات على :service',
            'body' => 'لم يؤكد المزوّد استعادة :count مسار(ات) إلى :service، لذا نتحقق مما حدث فعلًا. يُرجى عدم بدء استعادة أخرى — فقد تكون الأولى ما زالت تكتب.',
        ],
        'domain_registered' => [
            'title' => ':domain أصبح لك',
            'body' => ':domain مسجَّل حتى :date، وسيُجدَّد تلقائياً ما لم توقف ذلك.',
        ],
        'domain_registration_failed' => [
            'title' => 'تعذّر تسجيل :domain',
            'body' => 'رفض السجلّ تسجيل :domain. لقد دُفع المبلغ ولك حق استرداده، وفريقنا يرتّب ذلك.',
        ],
        'domain_expiring' => [
            'title' => ':domain ينتهي في :date',
            'body' => 'ينتهي :domain في :date. النطاق الذي ينقضي لا يمكن استعادته بالسعر المعتاد، وتتوقف عناوين البريد المرتبطة به.',
        ],
        'domain_needs_review' => [
            'title' => 'نتحقّق من :domain',
            'body' => 'لم يؤكّد السجلّ آخر إجراء على :domain، ونحن نتحقّق ممّا حدث فعلاً. من فضلك لا تُعِد المحاولة — سنُعلمك بالوضع.',
        ],
        'domain_redeemed' => [
            'title' => 'استُعيد :domain',
            'body' => ':domain عاد إلى حسابك ومسجَّل حتى :date. غرامة الاسترداد التي دفعتها غطّت استعادة السجلّ للاسم ومدّته.',
        ],
        'domain_redemption_failed' => [
            'title' => 'تعذّر استرداد :domain',
            'body' => 'رفض السجلّ استعادة :domain. لقد دُفعت غرامة الاسترداد ولك حق استردادها، وفريقنا يرتّب ذلك. سيحرّر السجلّ الاسم حين تنتهي نافذة الاسترداد.',
        ],
        'wordpress_push_completed' => [
            'title' => 'أصبح :domain هو نسخة التجربة',
            'body' => 'دُفعت نسخة التجربة فوق :domain (:scope). وقد استُبدل ما كان يحمله الموقع الحي في تلك الأجزاء من قبل.',
        ],
        'wordpress_push_failed' => [
            'title' => 'لم يكتمل الدفع إلى :domain',
            'body' => 'رفضت الأداة دفع نسخة التجربة فوق :domain. الموقع الحي كما كان.',
        ],
        'wordpress_push_needs_review' => [
            'title' => 'نتحقق من دفعٍ إلى :domain',
            'body' => 'لم تؤكد الأداة دفع نسخة التجربة فوق :domain. قد يكون الموقع الحي محدَّثًا جزئيًا. يُرجى عدم الدفع مجددًا — فريقنا يراجع الأمر.',
        ],
        'ticket_opened' => [
