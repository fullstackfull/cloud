...
use Lynomia\Modules\SharedHosting\Application\Handlers\PushWordPressToProductionHandler;
...
final class InfrastructureServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $handlers->register(CopyWordPressSiteHandler::class, ProvisioningJobKind::CopyWordPressSite);
        $handlers->register(PushWordPressToProductionHandler::class, ProvisioningJobKind::PushWordPressToProduction);
