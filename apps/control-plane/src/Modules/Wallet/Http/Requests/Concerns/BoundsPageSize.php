...
namespace Lynomia\Modules\Wallet\Http\Requests\Concerns;
 ...
 * for 100000 ledger entries means "as many as I can have", and answering with
 * 100 is more useful than a 422 — while the clamp, not the validation rule, is
 * what guarantees the query can never be handed a larger number.
 */
trait BoundsPageSize
{
    ...
    public function perPage(): int
    {
        ...
        // ?per_page=0 a slow way to walk the whole ledger.
        if ($requested < 1) {
