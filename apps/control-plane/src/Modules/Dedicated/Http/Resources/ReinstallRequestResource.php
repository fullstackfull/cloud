 ...
 * `needs_review` — the honest answer to "what is happening to my server" —
 * instead of a word that means something else to the scheduler. It is the same
 * vocabulary, from the same mapping, as the operation endpoint a client polls
 * afterwards: a receipt that named the state differently from the thing it is
 * a receipt for would be two answers to one question.
 *
