...
final class SafetyRefusal extends RuntimeException
{
    private function __construct(
        ...
        public readonly InfrastructureAction $attempted,
    ...
    public static function classDoesNotPermit(
        string $server,
        InfrastructureAction $attempted,
        SafetyClass $classification,
    ): self {
        $required = match ($attempted) {
            InfrastructureAction::Read => SafetyClass::DiscoveryOnly,
            InfrastructureAction::Configure => SafetyClass::ConfigurationAllowed,
            InfrastructureAction::Reimage => SafetyClass::ReimageAllowed,
        };
