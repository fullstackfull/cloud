...
namespace Lynomia\Modules\Payments\Http\Resources\Concerns;
 ...
 * that guesses two shows a customer that they were charged 90.00 KWD for a
 * 9.000 KWD invoice. So the currency travels with the amount, the integer
 * minor units are the authoritative field, and the decimal string is rendered
 * by Money rather than by division.
 */
