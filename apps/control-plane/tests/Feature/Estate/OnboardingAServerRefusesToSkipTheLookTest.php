...
use Lynomia\Modules\Estate\Application\Actions\ClassifyServer;
use Lynomia\Modules\Estate\Application\Actions\ClearForReimage;
use Lynomia\Modules\Estate\Application\Actions\RegisterServer;
use Lynomia\Modules\Estate\Application\Actions\RevokeReimageClearance;
use Lynomia\Modules\Estate\Application\Actions\TestConnection;
use Lynomia\Modules\Estate\Domain\Contracts\SecretResolver;
use Lynomia\Modules\Estate\Domain\DTOs\ServerRegistration;
use Lynomia\Modules\Estate\Domain\Enums\BlockerReason;
        ...
        $server = ManagedServer::factory()
            ...
            ->create([
                'credential_reference_id' => CredentialReference::factory()
                    ->forEnvironment(EstateEnvironment::Staging)
                    ->create()
                    ->getKey(),
            ]);
