 ...
 *   admin surface, which offers exactly one route that writes onto a job
 *   something a request supplies — the hosting-domain correction (F-04)
 *   — and that route is named below and driven with an overposted body,
 *   which is how it is shown to write one named column and leave the
 *   payload byte for byte as it was. That is
