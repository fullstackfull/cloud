...
| F-16 | High | SECURITY | `CLOSED` | `APP_ENV=Production` defeated every production guard. |
| F-17 | High | SECURITY | `CLOSED` | Invitation throttle keyed on an unvalidated header. |
