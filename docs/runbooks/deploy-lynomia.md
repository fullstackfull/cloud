...
infrastructure/scripts/preflight.sh staging     # reachability + classification, writes nothing
infrastructure/scripts/plan.sh      staging     # shows the diff, writes nothing
